...
app.post("/sendTextToGroup", async function sendTextToGroup(req, res, next) {
    var result = await Sessions.sendTextToGroup(req);
    res.json(result);
});//sendTextToGroup
...
//ANUNES 29042021
app.get("/getAllChatsGroups", async (req, res, next) => {
    var result = await Sessions.getAllChatsGroups(req.body.sessionName);
    res.json(result);
}); //getAllChatsGroups
